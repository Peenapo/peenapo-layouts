...
<p class="pl-editor-not-supported"><?php echo sprintf( esc_html__( 'Peenapo Layouts required the WordPress Editor Support, and this post type "%s" doesn\'t support it.', 'AAA' ), $post_type_obj->label ); ?></p>
<style type="text/css">
