...
class Playouts_Layout_Slider_Full extends Playouts_Admin_Layout {
    ...
    static function output() {
        return '[bw_row row_layout="full" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50" margin_top="100" margin_bottom="100"][bw_column overlay_bg_second="#f5f5f5" overlay_opacity="50"][bw_image_slider slide_width="50" spacing="25" thumbnail_size="large" adaptive_height="1" group_slides="2" autoplay_enable="1" autoplay="5000" stop_autoplay_hover="1" pagination_enable="1" infinite="1" attraction="0.025" friction="0.28"][bw_image_slider_item image="http://localhost/pp/demo/wp-content/uploads/2017/06/vincent-guth-192994.jpg"][/bw_image_slider_item][bw_image_slider_item image="http://localhost/pp/demo/wp-content/uploads/2017/06/john-towner-177554.jpg"][/bw_image_slider_item][bw_image_slider_item image="http://localhost/pp/demo/wp-content/uploads/2017/06/nathan-anderson-111801.jpg"][/bw_image_slider_item][/bw_image_slider][/bw_column][/bw_row]';
    }
}
...
class Playouts_Layout_Welcome_Text_Video extends Playouts_Admin_Layout {
    ...
    static function output() {
        return '[bw_row row_layout="standard" background="video" bg_video_mp4="http://localhost/pp/demo/wp-content/uploads/2017/06/home_video3.mp4" overlay_enable="1" overlay_bg_color="#ee4f89" overlay_bg_second="#423a8f" overlay_direction="left top" overlay_opacity="37" vertical_alignment="center" text_alignment="center" enable_static_height="1" static_height="100" text_color="#ffffff"][bw_column overlay_bg_second="#f5f5f5" overlay_opacity="50"][bw_animated_text h_tag="h4" text_alignment="inherit" font_size="60" line_height="150" text_color="#ffffff" bold_text="1" speed="450" delay="100"][bw_animated_text_item text="Duis volutpat felis at scelerisque"][/bw_animated_text_item][bw_animated_text_item text="Sollicitudin in laoreet in"][/bw_animated_text_item][/bw_animated_text][bw_row_inner text_alignment="inherit" vertical_alignment="center" padding_top="50" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50" animation="none" animation_speed="200" animation_delay="100"][bw_column_inner col_width="44.6" text_alignment="right" margin_right="40" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50"][bw_video_modal size="medium" size_button="medium" color="#ffffff" bg_color="#ed4f89"]https://www.youtube.com/watch?v=WX8D8xuvrKc[/bw_video_modal][/bw_column_inner][bw_column_inner col_width="55.4" text_alignment="left" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50"][bw_button label="Show me more please" link="#" style="large" bg_color="#ed4f89" bg_color_second="#f74b38" direction="bottom right" border_radius="60" transform_top="1" shadow="1"][/bw_button][/bw_column_inner][/bw_row_inner][/bw_column][/bw_row]';
    }
}
...
class Playouts_Layout_Notion_Box extends Playouts_Admin_Layout {
    ...
    static function output() {
        return '[bw_row row_layout="standard" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50" margin_top="100" margin_bottom="100"][bw_column col_width="50" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50" margin_right="30"][bw_notion_box top_text="Category" text="Suspendisse non arcu nec leo libero" sub_text="Vestibulum id lorem et mauris pharetra ultricies. Donec suscipit justo eget ante tristique volutpat." h_tag="h3" text_alignment="inherit" font_size="32" text_color="#ffffff" enable_link="1" link="#" bg_color="#f5f5f5" image="http://localhost/pp/demo/wp-content/uploads/2017/06/nathan-anderson-111801.jpg" scale="1" overlay="1" overlay_bg="#db9b2e"][/bw_notion_box][/bw_column][bw_column col_width="50" overlay_bg_second="#f5f5f5" overlay_direction="top right" overlay_opacity="50" margin_left="30"][bw_notion_box top_text="Category" text="Suspendisse non arcu nec leo libero" sub_text="Vestibulum id lorem et mauris pharetra ultricies. Donec suscipit justo eget ante tristique volutpat." h_tag="h3" text_alignment="inherit" font_size="32" text_color="#ffffff" enable_link="1" link="#" bg_color="#f5f5f5" image="http://localhost/pp/demo/wp-content/uploads/2017/06/john-towner-177554.jpg" scale="1" overlay="1" overlay_bg="#db9b2e"][/bw_notion_box][/bw_column][/bw_row]';
    }
}
