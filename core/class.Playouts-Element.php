...
/*if( class_exists('Playouts_Element_Element_Example') ) :
class Playouts_Element_Element_Example extends Playouts_Element {

    function init() {

        $this->module = 'bw_element_example';
        $this->name = esc_html__( 'Element Example', 'peenapo-layouts-txd' );
        $this->view = 'element';
        $this->category = array( 'content' => __( 'Content', 'peenapo-layouts-txd' ) );
        $this->module_color = '#77e08a';
        $this->params = array(
    ...
    static function output( $atts = array(), $content = null ) {
        ...
        return '<div class="pl-example-element' . $class . '" style="' . $style . '"' . $id . '>'.
            do_shortcode( $content ) .
        '</div>';

    }
}
new Playouts_Element_Element_Example;
endif;*/
